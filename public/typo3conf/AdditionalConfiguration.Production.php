...
// DB
$GLOBALS['TYPO3_CONF_VARS']['DB']['Connections']['Default']['dbname'] = 'typo3_mai'; # §§§DEVELOPMENT_DB_NAME§§§
$GLOBALS['TYPO3_CONF_VARS']['DB']['Connections']['Default']['host'] = 'localhost'; # §§§DEVELOPMENT_DB_HOSTNAME_OR_IP§§§
$GLOBALS['TYPO3_CONF_VARS']['DB']['Connections']['Default']['password'] = ''; # §§§DEVELOPMENT_DB_PASSWORD§§§
$GLOBALS['TYPO3_CONF_VARS']['DB']['Connections']['Default']['user'] = 'typo3_mai'; # §§§DEVELOPMENT_DB_USERNAME§§§

// MAIL
$GLOBALS['TYPO3_CONF_VARS']['MAIL']['defaultMailFromAddress'] = '';
$GLOBALS['TYPO3_CONF_VARS']['MAIL']['defaultMailReplyToAddress'] = '';
$GLOBALS['TYPO3_CONF_VARS']['MAIL']['defaultMailFromName'] = 'twagner';
$GLOBALS['TYPO3_CONF_VARS']['MAIL']['defaultMailReplyToName'] = 'twagner';
...
putenv("TYPO3_CONFIG_YAML=Production");
